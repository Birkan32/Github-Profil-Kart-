...
function createUserCard(user) {
  ...
  const cardHTML = `<div class="card"><img class="user-image" src="${user.avatar_url}" alt="${user.name}">
     <div class="user-info"> 
     <div class="user-name"><h2>${userName}</h2>
     ...
     <li><i class="fa-solid fa-user-group"></i>${user.following}<strong>Following</strong> </li>
...
function createErrorCard(msg) {
  const cardHTML = `<div class="card"> <h2>${msg}</h2> </div>`;
